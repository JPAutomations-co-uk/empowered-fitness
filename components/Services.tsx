...
const services = [
    {
        ...
        icon: <CgGym className="w-8 h-8 text-accent" />
    },
    {
        id: 2,
        ...
        icon: <RiLeafLine className="w-8 h-8 text-accent" />
    },
    {
        id: 3,
        ...
        icon: <RiHeartPulseLine className="w-8 h-8 text-accent" />
    }
];

export const Services = () => {
    return (
        <section className="py-[80px] px-5 max-w-7xl mx-auto">
            <SectionReveal>
                    ...
                    {services.map((service) => (
                        <motion.div key={service.id} variants={itemVariants} className="h-full">
                            <Card className="h-full flex flex-col items-start hover:cursor-pointer group">
                                <div className="w-14 h-14 rounded-2xl bg-accent/[0.08] flex items-center justify-center mb-6 border border-accent/10 group-hover:bg-accent/[0.12] transition-colors">
                                    {service.icon}
                                </div>

                                <h3 className="text-[20px] font-space-grotesk font-semibold text-text-primary mb-3">
                                    {service.title}
                                </h3>
