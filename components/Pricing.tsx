            ...
            <SectionReveal className="max-w-7xl mx-auto relative z-10">
                <div className="text-center mb-8 md:mb-16">
                    <motion.h2
                        ...
                        className="text-[26px] md:text-5xl font-space-grotesk font-bold text-text-primary mb-3 md:mb-6"
                    >
                        Invest in Yourself
                    </motion.h2>
                    <motion.p
                        variants={itemVariants}
                        className="text-[15px] md:text-xl text-text-secondary max-w-2xl mx-auto"
                    >
                ...
                <motion.div variants={itemVariants} className="w-full overflow-x-auto no-scrollbar pb-4 -mx-5 px-5 md:mx-0 md:px-0 md:overflow-visible">
                    <div className="flex gap-3 md:gap-6 lg:gap-8 w-max md:w-full md:grid md:grid-cols-3 md:items-start snap-x snap-mandatory">
                        ...
                        <div className="w-[80vw] md:w-full flex-shrink-0 md:flex-shrink snap-start h-full">
                            <div className="bg-white rounded-xl md:rounded-2xl border-t-[3px] border-t-accent border-r border-b border-l border-black/[0.04] p-5 md:p-8 flex flex-col h-full relative shadow-card">
                                ...
                                <h3 className="text-xl md:text-2xl font-space-grotesk font-semibold text-text-primary mb-1 md:mb-2">30-Day Meal Plan</h3>
                                <div className="text-3xl md:text-4xl font-space-grotesk font-black text-accent mb-5 md:mb-8">£4.99</div>
                                <ul className="flex flex-col gap-3 md:gap-4 mb-5 md:mb-8 flex-grow">
                        ...
                        <div className="w-[80vw] md:w-full flex-shrink-0 md:flex-shrink snap-start h-full md:mt-4">
                            <div className="bg-white rounded-xl md:rounded-2xl border border-black/[0.04] p-5 md:p-8 flex flex-col h-full hover:border-accent/20 transition-colors shadow-card">
                                <h3 className="text-xl md:text-2xl font-space-grotesk font-semibold text-text-primary mb-1 md:mb-2">Bespoke Nutrition Consultation</h3>
                                <div className="text-3xl md:text-4xl font-space-grotesk font-black text-text-primary mb-5 md:mb-8">£50</div>
                                <ul className="flex flex-col gap-3 md:gap-4 mb-5 md:mb-8 flex-grow">
                        ...
                        <div className="w-[80vw] md:w-full flex-shrink-0 md:flex-shrink snap-start h-full">
                            <div className="bg-white rounded-xl md:rounded-2xl border border-accent/20 shadow-card-hover p-5 md:p-8 flex flex-col h-full relative group hover:border-accent/40 transition-colors">
                                ...
                                <h3 className="text-xl md:text-2xl font-space-grotesk font-semibold text-text-primary mb-1 md:mb-2">PT Packages</h3>
